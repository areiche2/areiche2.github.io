this.wurdle = this.wurdle || {},
this.wurdle.bundle = function(e) {
    "use strict";
    function a(e) {
    ...
    var _a = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                ...
                this.shadowRoot.querySelector("#hash").textContent = null === (e = window.wurdle) || void 0 === e ? void 0 : e.hash,
    ...
    Ca("config", "G-2SSGMHY3NP", {
        app_version: null === (Ea = window.wurdle) || void 0 === Ea ? void 0 : Ea.hash,
        debug_mode: !1
    });
        ...
        return o(t, [{
            ...
            value: function() {
                ...
                this.$game.addEventListener("game-last-tile-revealed-in-row", (function(a) {
                    ...
                    lastTile && ([es, as].includes(e.gameStatus) && (e.restoringFromLocalStorage ? e.showStatsModal() : (e.gameStatus === es && (s.setAttribute("win", ""),
                ...
                this.shadowRoot.getElementById("settings-button").addEventListener("click", (function(a) {
                    var s = e.$game.querySelector("game-page")
                      , t = document.createTextNode("EVIL SETTINGS");
                    s.appendChild(t);
